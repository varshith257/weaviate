...
type ShardLike interface {
	...
	MergeObjectBatch(ctx context.Context, docs []*objects.MergeDocument) []error
	...
	prepareMergeObjects(context.Context, string, []*objects.MergeDocument) replica.SimpleResponse
