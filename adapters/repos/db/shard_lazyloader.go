...
func (l *LazyLoadShard) MergeObjectBatch(ctx context.Context,
...
func (l *LazyLoadShard) prepareMergeObjects(ctx context.Context, shardID string, docs []*objects.MergeDocument) replica.SimpleResponse {
	l.mustLoadCtx(ctx)
