...
type RemoteIndexClient interface {
	...
	BatchMergeObjects(ctx context.Context, hostName, indexName,
		shardName string, mergeDocs []*objects.MergeDocument) []error
...
func (ri *RemoteIndex) BatchMergeObjects(ctx context.Context, shardName string,
	...
	return ri.client.BatchMergeObjects(ctx, host, ri.class, shardName, mergeDocs)
}
